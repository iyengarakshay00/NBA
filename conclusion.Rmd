...
There are also a couple improvements we'd like to make to the interactive part. Adding a slider to adjust point transparency on the fly would have been cool. Additionally, we'd have liked to add dropdowns to allow selection of ANY player and ANY season. Then, when those get changed the visualization would update to show the selected player/year shot locations. Reading in all of that data turned out to be a harder task than imagined, so we did not have time to implement it.
